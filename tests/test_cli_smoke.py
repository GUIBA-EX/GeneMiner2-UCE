...
class CliSmokeTests(unittest.TestCase):
    def test_legacy_script_help(self):
        ...
        self.assertNotIn("--uce-path-strategy", proc.stdout)
        self.assertNotIn("--uce-backbone-lookahead", proc.stdout)
        self.assertIn("--uce-rescue-reads", proc.stdout)
        self.assertNotIn("--uce-rescue-min-density-ratio", proc.stdout)
        self.assertNotIn("--uce-max-contig-length", proc.stdout)
